...
sourceFile = r'D:\file\NLP\transe\baike_triples.txt' #CN-DBpedia triple data
trainFile = r'D:\file\NLP\transe\test.txt'
#trainFile = r'D:\file\NLP\transe\train.txt'
entity2idFile = r'D:\file\NLP\transe\entityMul2id.txt'
reletion2idFile = r'D:\file\NLP\transe\relationMul2id.txt'
...
def removeDup():
    entityFile = r'D:\file\NLP\transe\entity2id.txt'
    relationFile = r'D:\file\NLP\transe\relation2id.txt'
    m = 0
    n = 0
    entitySet = set()
    relationSet = set()
